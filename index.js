...
console.log(`Preferred Type of Monster Energy drink: ${userPreference}`)
...
if (cansLeft < 5) {
    console.log(`Time to restock!, Cans in stock: ${cansLeft}`);
}else {
    console.log(`We're stocked!, Cans in stock: ${cansLeft}`);
}
...
if (heartRate < 100) {
    console.log(`Your Heart Rate: ${heartRate} bpm, Boost Needed!`);
}else {
    console.log(`Your Heart Rate: ${heartRate} bpm, Energy levels are high!`);
}
...
if (currentTemp <= 5) {
    console.log(`Chilled to perfection! ${currentTemp}°C`);
}else {
    console.log(`Needs a cooler! ${currentTemp}°C`);
}
